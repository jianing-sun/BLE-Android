...
//            Log.d("onChara", "called!");
            ...
            pref = getContext().getSharedPreferences("Firebase", Context.MODE_PRIVATE);
            SharedPreferences.Editor edit = pref.edit();
            edit.putFloat("X value", (float) result[0]);
            edit.putFloat("Y value", (float) result[1]);
            edit.putFloat("Z value", (float) result[2]);
            edit.apply();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bFirebase:
                mDatabaseReference = FirebaseDatabase.getInstance().getReference();
                pref = getContext().getSharedPreferences("Firebase", Context.MODE_PRIVATE);
                float x_value = pref.getFloat("X value", 0);
                float y_value = pref.getFloat("Y value", 0);
                float z_value = pref.getFloat("Z value", 0);
                Toast.makeText(getContext(), "firebase please", Toast.LENGTH_SHORT).show();
                Log.d("FirebaseDebug", String.valueOf(x_value));
                Log.d("FirebaseDebug", String.valueOf(y_value));
                Log.d("FirebaseDebug", String.valueOf(z_value));
                // save data to firebase
                mDatabaseReference.child("Accelerometer: X axis").push().setValue(x_value);
                mDatabaseReference.child("Accelerometer: Y axis").push().setValue(y_value);
                mDatabaseReference.child("Accelerometer: Z axis").push().setValue(z_value);
...
//                        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFirebase = (Button) layout.findViewById(R.id.bFirebase);
        ...
        mFirebase.setOnClickListener(this);
